...
export const Headlings = ({
  ...
  if(!filteredContent || renderedContent === "<ul></ul>") return <></>;
  return (
    <ScrollArea
      className={cx(
        "prose prose-sm prose-li:list-none prose-a:no-underline hover:prose-a:text-[var(--link-color)] md:prose-ul:pl-0 lg:prose-ul:pl-3 flex flex-col mx-auto m-0 p-0 mt-.5 mb-5 md:mx-3 lg:mb-0 ring-1 ring-zinc-950/10 relative",
        className
      )}
      style={{
