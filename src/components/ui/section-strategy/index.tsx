    ...
    return (
      <section className={cx(styles.strategy, blinker.className)}>
        <div className={cx(styles.strategys)}>
          <div className={cx(styles.mindset, "rounded-xl")}>
            <h3>1. MINDSET</h3>
          ...
          <div className={cx(styles.estrategia, "rounded-xl")}>
            <h3>2. ESTRATÉGIA</h3>
          ...
          <div className={cx(styles.metricas, "rounded-xl")}>
            <h3>3. MÉTRICAS</h3>
          ...
          <div className={cx(styles.evolucao, "rounded-xl")}>
            <h3>4. EVOLUÇÃO</h3>
