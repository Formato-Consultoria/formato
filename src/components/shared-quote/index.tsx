import { PropsQuote } from "@/@types/article";

export function Quote({
  title, body
}: PropsQuote) {
  return (
    <blockquote className={"w-full text-lg py-5 pr-2 my-5 lg:my-5 border-l-2 border-solid border-y-transparent border-r-transparent border-l-purple-600 bg-purple-500/70"}>
